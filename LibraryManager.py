...
# ISBN VALIDATION THAT DOESN'T FUCKING WORK AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
            ISBN = str(ISBN)
            if len(ISBN) != 13:
            ...
            # Calculate the official 13th digit
            CheckDigit = (10 - (Total % 10)) % 10
            if CheckDigit != int(OldCheckDigit):
                return "Invalid ISBN, please check your spelling"
